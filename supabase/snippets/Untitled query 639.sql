-- Tworzymy profil (jeśli nie istnieje)
...
VALUES ('00000000-0000-0000-0000-000000000001', 'Pytanie o sesję', 'Siemanko! Czy ktoś z WZiKS ma już materiały do nauki na egzamin?', 'WZiKS');