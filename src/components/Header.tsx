      ...
      <div className="flex-1 flex justify-center items-center overflow-visible min-w-0">
        ...
        >
          <div
            ...
            className="mx-auto h-32 w-32 sm:w-40 md:w-48 scale-[0.85] translate-y-[2px] translate-x-[3.5px] md:translate-x-0 transition-colors dark:bg-brand-gold-bright bg-logo-navy"
          />
        </motion.button>
      </div>
