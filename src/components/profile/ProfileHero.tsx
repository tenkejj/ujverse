      ...
      >
        {bannerUrl ? (
          ...
          <div
            ...
            style={{
              backgroundImage:
                'radial-gradient(ellipse at 20% 0%, var(--profile-accent-soft) 0%, transparent 55%), radial-gradient(ellipse at 100% 100%, rgba(15,23,42,0.25) 0%, transparent 55%), linear-gradient(135deg, #0f172a 0%, #020617 100%)',
            }}
            aria-hidden
          />
        )}
