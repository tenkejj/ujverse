        ...
        <div className="min-h-0 flex-1 overflow-y-auto">
          <div className="mx-auto flex w-full max-w-3xl flex-col items-center px-4 pt-[10vh] pb-4 text-center md:px-6 md:pt-[14vh]">
            <motion.div
              ...
              className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#1e293b]/6 text-[#1e293b] dark:bg-brand-gold-bright/10 dark:text-brand-gold-bright"
            >
            ...
            <motion.h1
              ...
              className="bg-linear-to-br from-[#1e293b] to-[#1e293b]/60 bg-clip-text text-3xl font-semibold tracking-tight text-transparent md:text-4xl dark:from-brand-gold-bright dark:to-brand-gold-bright/55"
            >
            ...
            <motion.div
              ...
              className="mt-10 grid w-full grid-cols-1 gap-2 sm:grid-cols-2"
            >
              {QUICK_PROMPTS.map((prompt) => (
                <button
                  ...
                  disabled={isTyping}
                  className="w-full rounded-2xl border border-zinc-200 bg-white/70 px-4 py-3 text-left text-sm font-medium text-zinc-700 backdrop-blur-md transition-colors hover:border-[#1e293b]/30 hover:bg-zinc-50 hover:text-[#1e293b] disabled:cursor-not-allowed disabled:opacity-40 dark:border-white/10 dark:bg-zinc-950/50 dark:text-zinc-200 dark:hover:border-brand-gold-bright/30 dark:hover:bg-zinc-900/70 dark:hover:text-brand-gold-bright"
                >
                  {prompt}
                </button>
              ))}
