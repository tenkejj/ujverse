...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    visual: Sunrise,
    title: 'Mój Plan',
    subtitle: 'Twój dzień, tydzień i zmiany w jednym.',
    body: 'Zajęcia, postęp dnia, odwołania, komunikaty od wykładowców i AI brief — wszystko w jednym widoku.',
    ctaLabel: 'Zobacz Mój Plan',
    ctaPath: '/moj-plan',
  },
  {
    id: 'ai',
