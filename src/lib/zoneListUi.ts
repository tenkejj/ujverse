...
export const ZONES_LIST_PANEL_CLS = 'flex flex-col space-y-3'
...
export const ZONE_NAME_CLS =
  'min-w-0 flex-1 truncate text-sm font-semibold text-left text-zinc-900 dark:text-zinc-100 leading-snug'

export const ZONE_HASHTAG_CLS =
  'shrink-0 text-xs font-mono text-zinc-500'
