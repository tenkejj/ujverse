...
/**
 * AppOnboardingGate — montuje interaktywny tour pierwszaka kiedy
 * `useOnboarding.shouldShow` (brak `onboarding_completed_at` i
 * `onboarding_skipped_at` w profilu).
 */
function AppOnboardingGate({
  userId,
  myProfile,
  onProfilePatch,
}: {
